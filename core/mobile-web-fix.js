/* FramePro Mobile Web v5 — somente estrutura visual; controles e sensores vivem em módulos únicos */
(function(){
'use strict';
...
if(!document.getElementById('fp-mobile-web-v5-style')){
 const css=document.createElement('style');css.id='fp-mobile-web-v5-style';css.textContent=`
