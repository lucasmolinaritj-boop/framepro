(function () {
  ...
  async function loadPatchedEngine() {
    ...
    source = source.replace(legacyLock, "\n  /* lockLevel legado removido: o horizonte é controlado exclusivamente pelos sensores V61. */\n");
  ...
  async function loadEngine() {
    ...
    try { await loadScript("core/mobile-sensors-v8.js?v=61", "Falha ao carregar sensores mobile V61"); }
    catch (error) { console.warn(error.message); }
