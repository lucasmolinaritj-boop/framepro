(function () {
  ...
  async function loadPatchedEngine() {
    ...
    source = source.replace(legacyLock, "\n  /* lockLevel legado removido: o horizonte é controlado exclusivamente pelos sensores V64. */\n");
  ...
  async function loadEngine() {
    ...
    try { await loadScript("core/mobile-sensors-v8.js?v=64", "Falha ao carregar sensores mobile V64"); }
    catch (error) { console.warn(error.message); }
